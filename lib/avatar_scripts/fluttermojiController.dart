...
class FluttermojiController extends GetxController {
  ...
  void restoreState() async {
    ...
    print("myOptions: $selectedOptions");
    update();
  }
  ...
  String getFluttermojiFromOptions() {
    ...
    print("GOT FLUTTERMOJIFROMOPTIONS");
    ...
    print("MY PROPERTITIES: ${_getFluttermojiProperty('clotheType')}");
