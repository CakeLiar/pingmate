...
class Avataaar extends StatelessWidget {
  final double radius;
  final Color? backgroundColor;
  final List<dynamic> Is;
  final String mood;
  bool awake;

  Map<String, int>selectedOptions = {};

  Avataaar({Key? key, this.radius = 75.0, this.backgroundColor, required this.Is, required this.mood, this.awake = true})
      : super(key: key);
  ...
  String _getFluttermojiProperty(String type) {
    ...
    if (type == 'eyeType' && !awake) {
      return fluttermojiProperties[type]!
          .property!
          .elementAt(3);
    }
    if (type != 'eyeType' && type != 'mouthType') {
      return fluttermojiProperties[type]!
          .property!
...
<use fill="#D0C6AC" xlink:href="#path-5"></use>''' +
  ...
  Map<String, int> getFluttermojiOptions() {
    selectedOptions = {
      'topType': Is[0],
      'accessoriesType': Is[1],
      'hairColor': Is[2],
      'facialHairType': Is[3],
      'facialHairColor': Is[4],
      'clotheType': Is[5],
      'eyeType': Is[6],
      'eyebrowType': Is[7],
      'mouthType': Is[8],
