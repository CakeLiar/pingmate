...
Future<void> main() async {
  ...
  await Firebase.initializeApp(options: FirebaseOptions(
      apiKey: "AIzaSyBf876f5VFNSFd3b3g_nyV0CP5G2TdrNDE",
      appId: "chatapp-84582",
      messagingSenderId: "902626665095",
      projectId: "chatapp-84582"));
  runApp(const MyApp());
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _testSetCurrentScreen() async {
    await widget.analytics.setCurrentScreen(
      screenName: 'AvatarCreation',
      screenClassOverride: 'AvatarCreation',
    );
  ...
  Future<void> _testSetUserProperty() async {
    await widget.analytics.setUserProperty(name: 'fake user name', value: 'pinger');
